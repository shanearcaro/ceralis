        ...
        <div class="content-panel">
            <div class="panel-list-area">
                <ul class="panel-list">
                    ...
                    <div class="panel-div panel-hover"><li class="panel-element" id='panel-exam' onclick="window.location.href='questions'">CREATE QUESTIONS</li></div>
                    <div class="panel-div panel-hover"><li class="panel-element" id='panel-exam'>CREATE EXAM</li></div>
